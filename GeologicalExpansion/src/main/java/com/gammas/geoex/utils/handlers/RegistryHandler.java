...
public class RegistryHandler {
	...
	public static Block toBlock = BlockInit.BANDED_IRON_FORMATION; // change this to suit your need
	...
	{ 
	  ...
	  for (int x = 0; x < 16; ++x) 
	  {
	     for (int z = 0; z < 16; ++z) 
	     {
	         ...
	         {
	            if (theChunk.getBlockState(x, y, z).getBlock() == fromBlock && theChunk.getBiome(new BlockPos(x, y, z), theChunk.getWorld().getBiomeProvider()) == Biomes.RIVER)
	            {
	...
	public static void otherRegistries() {
		//GameRegistry.addShapedRecipe(new ResourceLocation("crudeiron"), new ResourceLocation("geoex"), new ItemStack(ItemInit.POWDER_CRUDE_IRON), "XXX", "XXX", "XXX", 'X', OreDictionary.);
